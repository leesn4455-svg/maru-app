...
import '../providers/site_provider.dart'; // 🌟 현장 정보를 불러오기 위해 추가
...
class _AddRecordModalState extends ConsumerState<AddRecordModal> {
  ...
  Widget build(BuildContext context) {
    // 🌟 [추가] Provider를 통해 저장된 현장 목록을 실시간으로 불러옵니다.
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              // 🌟 [새로운 기능] 저장된 현장 목록 원터치 입력 버튼
              if (savedSites.isNotEmpty) ...[
                const SizedBox(height: 10),
                const Text('저장된 현장 (터치 시 자동 입력)', style: TextStyle(fontSize: 12, color: Colors.grey, fontWeight: FontWeight.bold)),
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return Padding(
                        ...
                        child: ActionChip(
                          ...
                          onPressed: () {
                            setState(() {
                              siteC.text = site.siteName; // 🌟 이름 자동 입력!
                            });
                            Get.snackbar('현장 입력', '${site.siteName} 현장이 입력되었습니다.', duration: const Duration(seconds: 1), snackPosition: SnackPosition.TOP);
                          },
                        ),
                      );
                    },
