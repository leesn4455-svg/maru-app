...
import 'package:image_picker/image_picker.dart'; // 🌟 갤러리 항상 열기를 위해 원상 복구
                  ...
                  itemBuilder: (context, index) {
                    if (index == selectedPhotos.length) {
                      return GestureDetector(
                        // 🌟 [핵심] 다시 ImagePicker로 돌아가서 '앱 선택 팝업'이 뜨게 만듦! 여기서 삼성 갤러리 + 항상을 누르시면 됩니다!
                        onTap: () async {
